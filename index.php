...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="asset\section.css?v=1.11">
    ...
    <meta property="og:description" content="ส่งความสุขออนไลน์กับ มทร.ธัญบุรี"/>
  ...
  <body>
    ...
    <?php
      ...
      echo '<img class="zoom_card" style="max-width:100px" src="asset/card/'.$showem_all["card"].'" alt="">';
    ...
    <div class="container">
      <div class="row mt-2">
       <div class="col-12 text-center text-white textshadow" style="z-index:5;"data-aos="fade-down" data-aos-duration="2000">
           <h1 class="display-1">ส่งความสุขออนไลน์สู่ปี พ.ศ.2565</h1>
           <h1 class="display-5">มหาวิทยาลัยเทคโนโลยีราชมงคลธัญบุรี</h3>
           <h4 id="timer"></h4>
           <h5 class="mt-1">คลิกที่ซองจดหมายหรือการ์ดที่ลอยลงมาเพื่ออ่าน ส.ค.ส</h5>
       </div>
      </div>
    </div>
...
<div class="col-lg-12 col-sm-12 col-md-6">
  <button type="button" class="btn btn_newWish btn-lg w-100 shadow text-light" data-bs-toggle="modal" data-bs-target="#newwish"><i class="bi bi-file-plus"></i> สร้าง ส.ค.ส ของคุณ!</button>
</div>
</div>
...
<div class="modal fade" id="devinfo" tabindex="-1" aria-labelledby="fact" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <a href="xmas.php"><h6 style="color:#0077DD;">Nichapat Promson (Illust.)</h6></a>
      ...
      <blockquote class="blockquote">
      <p>"ขอให้ทุกท่าน เปิดกาชาได้ SSR ครับ รวมถึงพวกผมด้วย"</p>
      </blockquote>
      <figcaption class="blockquote-footer">
      เกลือ<cite title="Source Title">เค็ม</cite>
      </figcaption>
      </figure>
      <hr>
